        ...
        <div class="content mt-5 container-fluid">
            ...
            <div class="card " style="width: 20rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="registration1.php" class="btn btn-primary">Add Details</a>
                </div>
            </div>

            <!-- card 2 -->
            <div class="card " style="width: 20rem;">
                <img src="images/attendance.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Attendance</h5>
                    <p class="card-text">Get the attendance details</p>
            ...
            <!-- card 3 -->
            <div class="card " style="width: 20rem;">
                <img src="images/student_data.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Student Data</h5>
                    <p class="card-text">View registered students details</p>
                    <a href="student_data.php" class="btn btn-primary">View details</a>
                </div>
            </div>
        </div>
